...
/**
 * Class for annotation attribute source generation.
 * @extends AbstractSourceGenVisitor
 */
class AnnotationAttributeVisitor extends AbstractSourceGenVisitor {

    /**
     * Generate starting part of the annotation attribute.
     * @param { AnnotationAttribute } node - node to be generated.
     * @return {string} generated source fragment.
     */
    beginVisit(node) {
        return node.s`${'getKey'} : `;
    }

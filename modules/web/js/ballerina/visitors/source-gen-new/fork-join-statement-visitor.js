...
/**
 * Class for fork join statement source generation.
 * @extends AbstractSourceGenVisitor
 */
class ForkJoinStatementVisitor extends AbstractSourceGenVisitor {

    /**
     * Generate starting part of the fork join statement.
     * @param { ForkJoinStatement } node - node to be generated.

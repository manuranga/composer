...
/**
 * Class for else if statement source generation.
 * @extends AbstractSourceGenVisitor
 */
class ElseIfStatementVisitor extends AbstractSourceGenVisitor {

    /**
     * Generate starting part of the else if statement.
     * @param { ElseIfStatement } node - node to be generated.

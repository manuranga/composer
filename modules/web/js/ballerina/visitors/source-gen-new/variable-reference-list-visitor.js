...
/**
 * Class for variable reference list source generation.
 * @extends AbstractSourceGenVisitor
 */
class VariableReferenceListVisitor extends AbstractSourceGenVisitor {

    /**
     * Generate starting part of the variable reference list.
...
export default VariableReferenceListVisitor;

...
/**
 * Class for worker reply statement source generation.
 * @extends AbstractSourceGenVisitor
 */
class WorkerReplyStatementVisitor extends AbstractSourceGenVisitor {

    /**
     * Generate starting part of the worker reply statement.
     * @param { WorkerReplyStatement } node - node to be generated.

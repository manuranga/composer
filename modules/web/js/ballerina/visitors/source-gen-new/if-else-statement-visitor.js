...
/**
 * Class for if else statement source generation.
 * @extends AbstractSourceGenVisitor
 */
class IfElseStatementVisitor extends AbstractSourceGenVisitor {

    /**
     * Generate starting part of the if else statement.
     * @param { IfElseStatement } node - node to be generated.
